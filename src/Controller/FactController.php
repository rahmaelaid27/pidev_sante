...
final class FactController extends AbstractController{
    #[Route(name: 'app_fact_index', methods: ['GET'])]
    ...
    #[Route('/new', name: 'app_fact_new', methods: ['GET', 'POST'])]
    public function new(Request $request, EntityManagerInterface $entityManager): Response
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            return $this->redirectToRoute('app_fact_index', [], Response::HTTP_SEE_OTHER);
        }
    ...
    #[Route('/{id}', name: 'app_fact_show', methods: ['GET'])]
    ...
    #[Route('/{id}/edit', name: 'app_fact_edit', methods: ['GET', 'POST'])]
    ...
    #[Route('/{id}', name: 'app_fact_delete', methods: ['POST'])]
