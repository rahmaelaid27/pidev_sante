 ...
 */
final class Version20250217034937 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE avis ADD id_professional INT NOT NULL, CHANGE id ref INT AUTO_INCREMENT NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('DROP INDEX `PRIMARY` ON avis');
        $this->addSql('ALTER TABLE avis DROP id_professional, CHANGE ref id INT AUTO_INCREMENT NOT NULL');
